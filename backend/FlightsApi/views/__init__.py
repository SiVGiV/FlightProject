...
from .airline_views import AirlineView, AirlinesView
from .customer_views import CustomerView, CustomersView
...
from .user_views import LoginView, LogoutView, WhoAmIView, CSRFTokenView, UsersView