...
export default function FlightsPage() {
    ...
    const refreshFlights = useCallback(() => { // Refresh flights
        setLoading(true);
        var forceAirline = {};
        if (onlyMine) {
...
function FlightCreationModal({ showCreate, onHide, countries, forceRender }) {
    ...
    const [selectedOrigin, setSelectedOrigin] = useState([])
    const [selectedDestination, setSelectedDestination] = useState([])
    const [selectedDepartureDate, setSelectedDepartureDate] = useState(new Date().toJSON())
    const [selectedArrivalDate, setSelectedArrivalDate] = useState(new Date().toJSON())
    ...
    return (
        <>
            <Modal show={showCreate} onHide={onHide} backdrop="static" keyboard={false}>
                <Modal.Header closeButton>
                    <Modal.Title>Modal heading</Modal.Title>
                </Modal.Header>
                <Modal.Body><Form className="flightUpdateForm">
