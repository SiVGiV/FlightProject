...
export default function Register() {
    ...
    const [selectUserTypeVisibility, setSelectUserTypeVisibility] = useState({'display': 'none'});
    ...
    return (
        <>
            <div id="usertype-radio" style={ selectUserTypeVisibility }  onChange={ onUserTypeChange }>
                <input type="radio" value="customer" name="userType" id="customerUserTypeRadio" selected/><label for="customerUserTypeRadio">Customer</label><br />
                <input type="radio" value="airline" name="userType" id="airlineUserTypeRadio" /><label for="airlineUserTypeRadio">Airline</label><br />
                <input type="radio" value="admin" name="userType" id="adminUserTypeRadio" /><label for="adminUserTypeRadio">Admin</label><br />
            </div>
