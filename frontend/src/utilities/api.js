...
export default class API {
    ...
    countries = {
        get: ({ limit, page }) =>
            axios.get(`${this.API_URL}/countries/`, {
                params: {
                    limit: limit ?? undefined,
                    page: page ?? undefined,
                },
    ...
    flight = {
        ...
        patch: (id, params) =>
            axios.patch(`${this.API_URL}/flight/${id}/`, params),
        delete: id => axios.delete(`${this.API_URL}/flight/${id}/`),
    };

    flights = {
        get: ({ origin, destination, date, airline, page, limit }) =>
            axios.get(`${this.API_URL}/flights/`, {
                params: {
    ...
    airline = {
        ...
        patch: (id, params) =>
            axios.patch(`${this.API_URL}/airline/${id}/`, params),
        delete: id => axios.delete(`${this.API_URL}/airline/${id}/`),
    };

    airlines = {
        get: ({ name, limit, page }) =>
            axios.get(`${this.API_URL}/airlines/`, {
                params: {
                    name: name ?? undefined,
                    limit: limit ?? undefined,
                    page: page ?? undefined,
    ...
    customers = {
        get: ({ limit, page }) =>
            axios.get(`${this.API_URL}/customers/`, {
                params: {
                    limit: limit ?? undefined,
                    page: page ?? undefined,
                },
    ...
    tickets = {
        get: ({ limit, page }) =>
            axios.get(`${this.API_URL}/tickets/`, {
                params: {
                    limit: limit ?? undefined,
                    page: page ?? undefined,
                },
